...
''' A simple and thin Python library for the Spotify Web API
    -- Small modification from Spotipy Package to include
    api call for current user's recent listening history --
'''
...
class Spotify_mod(object):
    ...
    def current_user_recently_played(self, after=None, before=None, limit=20):
        ''' Gets a list of the tracks saved in the current authorized user's
            "Your Music" library
            Parameters:
                - limit - the number of tracks to return
                - after - A timestamp in ISO 8601 format:
                  yyyy-MM-ddTHH:mm:ss. Use this parameter to specify the time
                  after which you want to return the user's history. Cannot be
                  specified if a before parameter is used
                - before - A timestamp in ISO 8601 format:
                  yyyy-MM-ddTHH:mm:ss. Use this parameter to specify the time
                  before which you want to return the user's history. Cannot be
                  specified if an after parameter is used
        '''
